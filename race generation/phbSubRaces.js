let racialFeats = require('./racialFeats')
...
const hillDwarf = {
  ...
  abilityMod: { wis: +1 },
  racialFeats: [racialFeats.dwarvenToughness]
};
const mountainDwarf = {
  name: "Mountain Dwarf",
  desc:
  ...
  abilityMod: { str: +2 },
  racialFeats: [racialFeats.dwarvenArmorTraining]
};
const highElf = {
  name: "High Elf",
  desc:
  ...
  abilityMod: { int: +1 },
  racialFeats: [racialFeats.elfWeaponTraining, racialFeats.cantrip, racialFeats.extraLanguage]
};
const darkElf = {
  name: "Dark Elf (Drow)",
  desc: "",
  abilityMod: { cha: +1 },
  racialFeats: [
    racialFeats.superiorDarkvision,
    racialFeats.sunlightSensitivity,
    racialFeats.drowWeaponTraining,
    racialFeats.drowMagic
  ]
};
const deepGnome = {
  name: "Deep Gnome",
  ...
  abilityMod: { dex: +1 },
  racialFeats: [racialFeats.superiorDarkvision, racialFeats.stoneCamoflauge, racialFeats.undercommon]
};
const rockGnome = {
  name: "Rock Gnome",
  desc:
  ...
  abilityMod: { con: +1 },
  racialFeats: [racialFeats.artificersLore, racialFeats.tinker]
};
const lightfootHalfling = {
  ...
  abilityMod: { cha: +1 },
  racialFeats: [racialFeats.naturallyStealthy]
};
const stoutHalfling = {
  name: "Stout Halfling",
  desc:
  ...
  abilityMod: { con: +1 },
  racialFeats: [racialFeats.stoutResilience]
};
const humanVariant = {
  name: "Human Variant",
  desc:
  ...
  racialFeats: [racialFeats.any1Skill, racialFeats.any1Feat]
};
