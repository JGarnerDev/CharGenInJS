...
const dragonborn = {
  ...
  racialFeatures: [racialFeatures.draconicAncestry, racialFeatures.breathWeapon, racialFeatures.draconicDamageResistance],
  source: "PHB"
};
...
const dwarf = {
  ...
  abilityMod: { con: +2 },
  movement: { walking: "25", swim: undefined , fly: undefined , climb: undefined  },
  details: {
    desc: undefined ,
    age:
...
const elf = {
  ...
  racialFeatures: [racialFeatures.darkvision, racialFeatures.keenSenses, racialFeatures.feyAncestry, racialFeatures.trance],
  source: "EEPC"
};
const gnome = {
  race: "Gnome",
...
const halfOrc = {
  ...
  racialFeatures: [racialFeatures.darkvision, racialFeatures.menacing, racialFeatures.relentlessEndurace, racialFeatures.savageAttacks],
  source: "EEPC"
};
const halfling = {
  race: "Halfling",
  ...
  racialFeatures: [racialFeatures.lucky, racialFeatures.brave, racialFeatures.halflingNimbleness],
  source: "EEPC"
};
const human = {
  race: "Human",
...
const tiefling = {
  ...
  racialFeatures: [racialFeatures.darkvision, racialFeatures.hellishResistance, racialFeatures.infernalLegacy],
  source: "EEPC"
};
