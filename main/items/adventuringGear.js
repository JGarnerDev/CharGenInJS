...
const adventuringGear = {
  ...
  chain: chain,
  chalk: chalk,
  charlatanChoice: charlatanChoice,
  ...
  crowbar: crowbar,
  darkCommonClothes: darkCommonClothes,
  diceSet: diceSet,
  disguiseKit: disguiseKit,
  drum: drum,
  dulcimer: dulcimer,
  entertainerOption: entertainerOption,
  enemyTrophy: enemyTrophy,
  ...
  hermitScrollCase: hermitScrollCase,
  holyWater: holyWater,
  ...
  ladder: ladder,
  lamp: lamp,
  letterFromGuild: letterFromGuild,
  letterFromDeadColleague: letterFromDeadColleague,
  lock: lock,
  ...
  rod: rod,
  sack: sack,
  scrollOfPedigree: scrollOfPedigree,
  ...
  stickOfIncense: stickOfIncense,
  tent: tent,
  thievesTools: thievesTools,
  tinderbox: tinderbox,
  tinkersTools: tinkersTools,
  tokenOfParents: tokenOfParents,
  torch: torch,
  totem: totem,
